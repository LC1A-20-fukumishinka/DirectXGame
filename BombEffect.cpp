...
void BombEffect::Bomb(const DirectX::XMFLOAT3 &pos, float speed, const int timer)
{
	...
	for (int i = 0; i < 20; i++)
	{
		...
		bombParticle->Add(timer, pos, angle * speed, Vector3(), 15, 5, DirectX::XMFLOAT4 {0.3f, 0, 0, 1}, DirectX::XMFLOAT4{ 0.3, 0, 0, 1 });
	}
}
